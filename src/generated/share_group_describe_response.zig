...
//! Message: ShareGroupDescribeResponse
//! API Key: 77
//! Type: response
//! Valid Versions: 1
//! Flexible Versions: 0+
...
pub const ShareGroupDescribeResponse = struct {
    ...
    /// Create a default instance of ShareGroupDescribeResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .groups = null,
    ...
    /// Encode ShareGroupDescribeResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
    ...
    /// Compute the size of ShareGroupDescribeResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
    ...
    /// Decode ShareGroupDescribeResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
