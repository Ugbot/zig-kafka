...
/// Nested struct: AlterConfigsResourceResponse
...
pub const AlterConfigsResponse = struct {
    ...
    responses: ?[]AlterConfigsResourceResponse = null,
    ...
    /// Create a default instance of AlterConfigsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .responses = null,
    ...
    /// The responses for each resource.
    pub fn withResponses(self: Self, value: ?[]AlterConfigsResourceResponse) Self {
        var result = self;
        result.responses = value;
        return result;
    }

    /// Encode AlterConfigsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.responses) |arr| {
                    for (arr) |*item| {
                        try AlterConfigsResourceResponse.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of AlterConfigsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.responses) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try AlterConfigsResourceResponse.computeSize(item, version);
                }
            } else {
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(AlterConfigsResourceResponse, array_len);
            for (array) |*item| {
                item.* = try AlterConfigsResourceResponse.decode(reader, version, allocator);
            }
