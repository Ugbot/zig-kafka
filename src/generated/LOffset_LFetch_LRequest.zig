...
pub const OffsetFetchRequestTopics = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 8 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArray(i32, writer, self.partition_indexes, types.encodeInt32);
            } else {
                try types.encodeArray(i32, writer, self.partition_indexes, types.encodeInt32);
            }
        }
