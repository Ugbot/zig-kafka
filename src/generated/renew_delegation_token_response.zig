...
pub const RenewDelegationTokenResponse = struct {
    const Self = @This();
    ...
    /// Create a default instance of RenewDelegationTokenResponse
    pub fn default() Self {
        return .{
            .error_code = 0,
    ...
    /// Encode RenewDelegationTokenResponse
    ...
    /// Compute the size of RenewDelegationTokenResponse for the given version
    ...
    /// Decode RenewDelegationTokenResponse
