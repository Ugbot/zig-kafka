...
pub const ListConfigResourcesRequest = struct {
    ...
    /// Create a default instance of ListConfigResourcesRequest
    pub fn default() Self {
        return .{
            .resource_types = null,
            ._tagged_fields = null,
    ...
    /// The list of resource type. If the list is empty, it uses default supported config resource types.
    /// Versions: 1+
    pub fn withResourceTypes(self: Self, value: ?[]i8) Self {
        var result = self;
        result.resource_types = value;
        return result;
    }

    /// Encode ListConfigResourcesRequest
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 1 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull(i8, writer, self.resource_types, types.encodeInt8);
            } else {
                try types.encodeArrayNonNull(i8, writer, self.resource_types, types.encodeInt8);
            }
        }
    ...
    /// Compute the size of ListConfigResourcesRequest for the given version
    ...
    /// Decode ListConfigResourcesRequest
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: ResourceTypes
        if (version >= 1 and version <= 32767) {
            self.resource_types = if (is_flexible)
