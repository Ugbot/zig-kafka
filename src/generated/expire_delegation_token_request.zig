...
pub const ExpireDelegationTokenRequest = struct {
    ...
    /// Create a default instance of ExpireDelegationTokenRequest
    pub fn default() Self {
        return .{
            .hmac = &[_]u8{},
    ...
    /// The expiry time period in milliseconds.
    pub fn withExpiryTimePeriodMs(self: Self, value: i64) Self {
        var result = self;
        result.expiry_time_period_ms = value;
        return result;
    }

    /// Encode ExpireDelegationTokenRequest
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: ExpiryTimePeriodMs
        if (version >= 0 and version <= 32767) {
            try types.encodeInt64(writer, self.expiry_time_period_ms);
        }
    ...
    /// Compute the size of ExpireDelegationTokenRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: ExpiryTimePeriodMs
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt64(self.expiry_time_period_ms);
        }
    ...
    /// Decode ExpireDelegationTokenRequest
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: ExpiryTimePeriodMs
        if (version >= 0 and version <= 32767) {
            self.expiry_time_period_ms = try types.decodeInt64(reader);
        }
