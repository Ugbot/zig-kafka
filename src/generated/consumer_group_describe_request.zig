...
pub const ConsumerGroupDescribeRequest = struct {
    ...
    /// Create a default instance of ConsumerGroupDescribeRequest
    pub fn default() Self {
        return .{
            .group_ids = null,
    ...
    /// Encode ConsumerGroupDescribeRequest
    ...
    /// Compute the size of ConsumerGroupDescribeRequest for the given version
    ...
    /// Decode ConsumerGroupDescribeRequest
