...
pub const UnregisterBrokerResponse = struct {
    ...
    /// Create a default instance of UnregisterBrokerResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Encode UnregisterBrokerResponse
    ...
    /// Compute the size of UnregisterBrokerResponse for the given version
    ...
    /// Decode UnregisterBrokerResponse
