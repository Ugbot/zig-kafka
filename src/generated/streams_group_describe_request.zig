...
pub const StreamsGroupDescribeRequest = struct {
    const Self = @This();
    ...
    /// Create a default instance of StreamsGroupDescribeRequest
    pub fn default() Self {
        return .{
            .group_ids = null,
    ...
    /// Encode StreamsGroupDescribeRequest
    ...
    /// Compute the size of StreamsGroupDescribeRequest for the given version
    ...
    /// Decode StreamsGroupDescribeRequest
