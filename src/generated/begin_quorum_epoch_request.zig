...
//! Message: BeginQuorumEpochRequest
//! API Key: 53
//! Type: request
//! Valid Versions: 0-1
//! Flexible Versions: 1+
...
pub const BeginQuorumEpochRequest = struct {
    ...
    /// Create a default instance of BeginQuorumEpochRequest
    pub fn default() Self {
        return .{
            .cluster_id = null,
            .voter_id = -1,
    ...
    /// Encode BeginQuorumEpochRequest
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
    ...
    /// Compute the size of BeginQuorumEpochRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
    ...
    /// Decode BeginQuorumEpochRequest
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
