...
pub const AllocateProducerIdsResponse = struct {
    const Self = @This();
    ...
    producer_id_start: i64 = 0,
    /// The number of producer IDs in this range.
    producer_id_len: i32 = 0,
    ...
    /// Create a default instance of AllocateProducerIdsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// The first producer ID in this range, inclusive.
    pub fn withProducerIdStart(self: Self, value: i64) Self {
        var result = self;
        result.producer_id_start = value;
        return result;
    }

    /// Sets `producer_id_len` to the passed value.
    /// The number of producer IDs in this range.
    pub fn withProducerIdLen(self: Self, value: i32) Self {
        var result = self;
        result.producer_id_len = value;
        return result;
    }

    /// Encode AllocateProducerIdsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: ProducerIdStart
        if (version >= 0 and version <= 32767) {
            try types.encodeInt64(writer, self.producer_id_start);
        }

        // Field: ProducerIdLen
        if (version >= 0 and version <= 32767) {
            try types.encodeInt32(writer, self.producer_id_len);
        }
    ...
    /// Compute the size of AllocateProducerIdsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: ProducerIdStart
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt64(self.producer_id_start);
        }

        // Field: ProducerIdLen
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt32(self.producer_id_len);
        }
    ...
    /// Decode AllocateProducerIdsResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: ProducerIdStart
        if (version >= 0 and version <= 32767) {
            self.producer_id_start = try types.decodeInt64(reader);
        }

        // Field: ProducerIdLen
        if (version >= 0 and version <= 32767) {
            self.producer_id_len = try types.decodeInt32(reader);
        }
