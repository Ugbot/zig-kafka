...
pub const ControllerRegistrationResponse = struct {
    ...
    /// Create a default instance of ControllerRegistrationResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Encode ControllerRegistrationResponse
    ...
    /// Compute the size of ControllerRegistrationResponse for the given version
    ...
    /// Decode ControllerRegistrationResponse
