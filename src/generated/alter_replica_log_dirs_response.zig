...
/// Nested struct: AlterReplicaLogDirTopicResult
pub const AlterReplicaLogDirTopicResult = struct {
    ...
    /// Versions: 0+
    partitions: ?[]AlterReplicaLogDirPartitionResult = null,
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.partitions) |arr| {
                    for (arr) |*item| {
                        try AlterReplicaLogDirPartitionResult.encode(item, writer, version);
                    }
                }
            } else {
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        if (version >= 0 and version <= 32767) {
            if (self.partitions) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try AlterReplicaLogDirPartitionResult.computeSize(item, version);
                }
            } else {
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(AlterReplicaLogDirPartitionResult, array_len);
            for (array) |*item| {
                item.* = try AlterReplicaLogDirPartitionResult.decode(reader, version, allocator);
            }
...
/// Nested struct: AlterReplicaLogDirPartitionResult
...
pub const AlterReplicaLogDirsResponse = struct {
    ...
    results: ?[]AlterReplicaLogDirTopicResult = null,
    ...
    /// Create a default instance of AlterReplicaLogDirsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .results = null,
    ...
    /// The results for each topic.
    pub fn withResults(self: Self, value: ?[]AlterReplicaLogDirTopicResult) Self {
        var result = self;
        result.results = value;
        return result;
    }

    /// Encode AlterReplicaLogDirsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.results) |arr| {
                    for (arr) |*item| {
                        try AlterReplicaLogDirTopicResult.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of AlterReplicaLogDirsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.results) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try AlterReplicaLogDirTopicResult.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    /// Decode AlterReplicaLogDirsResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(AlterReplicaLogDirTopicResult, array_len);
            for (array) |*item| {
                item.* = try AlterReplicaLogDirTopicResult.decode(reader, version, allocator);
            }
            self.results = array;
        }
