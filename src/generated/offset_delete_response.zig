...
/// Nested struct: OffsetDeleteResponseTopic
pub const OffsetDeleteResponseTopic = struct {
    ...
    /// Versions: 0+
    partitions: ?[]OffsetDeleteResponsePartition = null,
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.partitions) |arr| {
                    for (arr) |*item| {
                        try OffsetDeleteResponsePartition.encode(item, writer, version);
                    }
                }
            } else {
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        if (version >= 0 and version <= 32767) {
            if (self.partitions) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try OffsetDeleteResponsePartition.computeSize(item, version);
                }
            } else {
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(OffsetDeleteResponsePartition, array_len);
            for (array) |*item| {
                item.* = try OffsetDeleteResponsePartition.decode(reader, version, allocator);
            }
...
/// Nested struct: OffsetDeleteResponsePartition
...
pub const OffsetDeleteResponse = struct {
    ...
    topics: ?[]OffsetDeleteResponseTopic = null,
    ...
    /// Create a default instance of OffsetDeleteResponse
    pub fn default() Self {
        return .{
            .error_code = 0,
            .throttle_time_ms = 0,
    ...
    /// The responses for each topic.
    pub fn withTopics(self: Self, value: ?[]OffsetDeleteResponseTopic) Self {
        var result = self;
        result.topics = value;
        return result;
    }

    /// Encode OffsetDeleteResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.topics) |arr| {
                    for (arr) |*item| {
                        try OffsetDeleteResponseTopic.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of OffsetDeleteResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.topics) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try OffsetDeleteResponseTopic.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(OffsetDeleteResponseTopic, array_len);
            for (array) |*item| {
                item.* = try OffsetDeleteResponseTopic.decode(reader, version, allocator);
            }
            self.topics = array;
        }
