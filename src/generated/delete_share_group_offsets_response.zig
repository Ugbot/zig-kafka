...
/// Nested struct: DeleteShareGroupOffsetsResponseTopic
pub const DeleteShareGroupOffsetsResponseTopic = struct {
    const Self = @This();
...
pub const DeleteShareGroupOffsetsResponse = struct {
    const Self = @This();
    ...
    responses: ?[]DeleteShareGroupOffsetsResponseTopic = null,
    ...
    /// Create a default instance of DeleteShareGroupOffsetsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// The results for each topic.
    pub fn withResponses(self: Self, value: ?[]DeleteShareGroupOffsetsResponseTopic) Self {
        var result = self;
        result.responses = value;
        return result;
    }

    /// Encode DeleteShareGroupOffsetsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.responses) |arr| {
                    for (arr) |*item| {
                        try DeleteShareGroupOffsetsResponseTopic.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of DeleteShareGroupOffsetsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.responses) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try DeleteShareGroupOffsetsResponseTopic.computeSize(item, version);
                }
            } else {
    ...
    /// Decode DeleteShareGroupOffsetsResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(DeleteShareGroupOffsetsResponseTopic, array_len);
            for (array) |*item| {
                item.* = try DeleteShareGroupOffsetsResponseTopic.decode(reader, version, allocator);
            }
