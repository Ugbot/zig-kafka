...
pub const AlterConfigsRequest = struct {
    ...
    /// Create a default instance of AlterConfigsRequest
    pub fn default() Self {
        return .{
            .resources = null,
            .validate_only = false,
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLen(writer, self.resources);
                ...
                try types.encodeArrayLen(writer, self.resources);
                if (self.resources) |arr| {
                    for (arr) |*item| {
                        try AlterConfigsResource.encode(item, writer, version);
                    }
    ...
    /// Compute the size of AlterConfigsRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
