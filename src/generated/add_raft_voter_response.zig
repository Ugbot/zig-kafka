...
pub const AddRaftVoterResponse = struct {
    const Self = @This();
    ...
    /// Create a default instance of AddRaftVoterResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Compute the size of AddRaftVoterResponse for the given version
