...
pub const ListGroupsRequest = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 4 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArray([]const u8, writer, self.states_filter, types.encodeCompactString);
            } else {
                try types.encodeArray([]const u8, writer, self.states_filter, types.encodeCompactString);
            }
        }
        ...
        if (version >= 5 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArray([]const u8, writer, self.types_filter, types.encodeCompactString);
            } else {
                try types.encodeArray([]const u8, writer, self.types_filter, types.encodeCompactString);
            }
        }
