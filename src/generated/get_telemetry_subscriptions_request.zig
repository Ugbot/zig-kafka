...
pub const GetTelemetrySubscriptionsRequest = struct {
    ...
    /// Create a default instance of GetTelemetrySubscriptionsRequest
    pub fn default() Self {
        return .{
    ...
    /// Encode GetTelemetrySubscriptionsRequest
    ...
    /// Compute the size of GetTelemetrySubscriptionsRequest for the given version
    ...
    /// Decode GetTelemetrySubscriptionsRequest
