...
pub const PartitionData = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: VoteGranted
        if (version >= 0 and version <= 32767) {
            try types.encodeBoolean(writer, self.vote_granted);
        }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: VoteGranted
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeBoolean(self.vote_granted);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: VoteGranted
        if (version >= 0 and version <= 32767) {
            self.vote_granted = try types.decodeBoolean(reader);
        }
...
pub const VoteResponse = struct {
    ...
    /// Create a default instance of VoteResponse
    pub fn default() Self {
        return .{
            .error_code = 0,
            .topics = null,
    ...
    /// Compute the size of VoteResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
