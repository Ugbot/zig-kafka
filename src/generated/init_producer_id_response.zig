...
pub const InitProducerIdResponse = struct {
    ...
    /// Versions: 6+
    ongoing_txn_producer_epoch: i16 = -1,
    ...
    /// Create a default instance of InitProducerIdResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// The producer id for ongoing transaction when KeepPreparedTxn is used, -1 if there is no transaction ongoing.
    /// Versions: 6+
    pub fn withOngoingTxnProducerId(self: Self, value: i64) Self {
        var result = self;
        result.ongoing_txn_producer_id = value;
        return result;
    }
    ...
    /// The epoch associated with the  producer id for ongoing transaction when KeepPreparedTxn is used, -1 if there is no transaction ongoing.
    /// Versions: 6+
    pub fn withOngoingTxnProducerEpoch(self: Self, value: i16) Self {
        var result = self;
        result.ongoing_txn_producer_epoch = value;
        return result;
    }

    /// Encode InitProducerIdResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 6 and version <= 32767) {
            try types.encodeInt64(writer, self.ongoing_txn_producer_id);
        }

        // Field: OngoingTxnProducerEpoch
        if (version >= 6 and version <= 32767) {
            try types.encodeInt16(writer, self.ongoing_txn_producer_epoch);
        }
    ...
    /// Compute the size of InitProducerIdResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: OngoingTxnProducerId
        if (version >= 6 and version <= 32767) {
            total_size += types.computeSizeInt64(self.ongoing_txn_producer_id);
        }

        // Field: OngoingTxnProducerEpoch
        if (version >= 6 and version <= 32767) {
            total_size += types.computeSizeInt16(self.ongoing_txn_producer_epoch);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: OngoingTxnProducerId
        if (version >= 6 and version <= 32767) {
            self.ongoing_txn_producer_id = try types.decodeInt64(reader);
        }

        // Field: OngoingTxnProducerEpoch
        if (version >= 6 and version <= 32767) {
            self.ongoing_txn_producer_epoch = try types.decodeInt16(reader);
        }
