...
pub const SnapshotFooterRecord = struct {
    ...
    /// Create a default instance of SnapshotFooterRecord
    pub fn default() Self {
        return .{
            .version = 0,
            ._tagged_fields = null,
    ...
    /// Compute the size of SnapshotFooterRecord for the given version
