...
pub const AllocateProducerIdsRequest = struct {
    ...
    /// Create a default instance of AllocateProducerIdsRequest
    pub fn default() Self {
        return .{
            .broker_id = 0,
            .broker_epoch = -1,
    ...
    /// Encode AllocateProducerIdsRequest
    ...
    /// Compute the size of AllocateProducerIdsRequest for the given version
    ...
    /// Decode AllocateProducerIdsRequest
