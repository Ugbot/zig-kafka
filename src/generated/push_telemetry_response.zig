...
pub const PushTelemetryResponse = struct {
    ...
    /// Create a default instance of PushTelemetryResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Compute the size of PushTelemetryResponse for the given version
