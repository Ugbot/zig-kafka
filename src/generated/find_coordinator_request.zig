...
pub const FindCoordinatorRequest = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 4 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull([]const u8, writer, self.coordinator_keys, types.encodeCompactString);
            } else {
                try types.encodeArrayNonNull([]const u8, writer, self.coordinator_keys, types.encodeCompactString);
            }
        }
