...
//! Message: RemoveRaftVoterResponse
//! API Key: 81
//! Type: response
//! Valid Versions: 0
//! Flexible Versions: 0+
...
pub const RemoveRaftVoterResponse = struct {
    const Self = @This();
    ...
    /// Create a default instance of RemoveRaftVoterResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Encode RemoveRaftVoterResponse
    ...
    /// Compute the size of RemoveRaftVoterResponse for the given version
    ...
    /// Decode RemoveRaftVoterResponse
