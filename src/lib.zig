...
pub const client = struct {
    ...
    pub const Producer = @import("client/producer/producer.zig").Producer;
    pub const Consumer = @import("client/consumer/consumer.zig").Consumer;
    pub const Admin = @import("client/admin/admin.zig").Admin;
};

// Re-export commonly used types for convenience
pub const KafkaClient = client.KafkaClient;
pub const Producer = client.Producer;
pub const Consumer = client.Consumer;
pub const Admin = client.Admin;
