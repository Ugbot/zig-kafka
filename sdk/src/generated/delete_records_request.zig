...
/// Nested struct: DeleteRecordsTopic
pub const DeleteRecordsTopic = struct {
    ...
    /// Versions: 0+
    partitions: ?[]DeleteRecordsPartition = null,
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.partitions) |arr| {
                    for (arr) |*item| {
                        try DeleteRecordsPartition.encode(item, writer, version);
                    }
                }
            } else {
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        if (version >= 0 and version <= 32767) {
            if (self.partitions) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try DeleteRecordsPartition.computeSize(item, version);
                }
            } else {
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(DeleteRecordsPartition, array_len);
            for (array) |*item| {
                item.* = try DeleteRecordsPartition.decode(reader, version, allocator);
            }
...
/// Nested struct: DeleteRecordsPartition
...
pub const DeleteRecordsRequest = struct {
    ...
    topics: ?[]DeleteRecordsTopic = null,
    ...
    /// Create a default instance of DeleteRecordsRequest
    pub fn default() Self {
        return .{
            .topics = null,
            .timeout_ms = 0,
    ...
    /// Each topic that we want to delete records from.
    pub fn withTopics(self: Self, value: ?[]DeleteRecordsTopic) Self {
        var result = self;
        result.topics = value;
        return result;
    }
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.topics) |arr| {
                    for (arr) |*item| {
                        try DeleteRecordsTopic.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of DeleteRecordsRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.topics) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try DeleteRecordsTopic.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(DeleteRecordsTopic, array_len);
            for (array) |*item| {
                item.* = try DeleteRecordsTopic.decode(reader, version, allocator);
            }
            self.topics = array;
        }
