...
pub const SaslHandshakeResponse = struct {
    ...
    /// Create a default instance of SaslHandshakeResponse
    pub fn default() Self {
        return .{
            .error_code = 0,
            .mechanisms = null,
    ...
    /// The mechanisms enabled in the server.
    pub fn withMechanisms(self: Self, value: ?[][]const u8) Self {
        var result = self;
        result.mechanisms = value;
        return result;
    }

    /// Encode SaslHandshakeResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull([]const u8, writer, self.mechanisms, types.encodeCompactString);
            } else {
                try types.encodeArrayNonNull([]const u8, writer, self.mechanisms, types.encodeCompactString);
            }
        }
    ...
    /// Compute the size of SaslHandshakeResponse for the given version
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: Mechanisms
        if (version >= 0 and version <= 32767) {
            self.mechanisms = if (is_flexible)
