...
pub const PartitionData = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: ReplicaEpoch
        if (version >= 0 and version <= 32767) {
            try types.encodeInt32(writer, self.replica_epoch);
        }
        ...
        // Field: LastOffsetEpoch
        if (version >= 0 and version <= 32767) {
            try types.encodeInt32(writer, self.last_offset_epoch);
        }
        ...
        if (version >= 2 and version <= 32767) {
            try types.encodeBoolean(writer, self.pre_vote);
        }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: ReplicaEpoch
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt32(self.replica_epoch);
        }
        ...
        // Field: LastOffsetEpoch
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt32(self.last_offset_epoch);
        }
        ...
        // Field: PreVote
        if (version >= 2 and version <= 32767) {
            total_size += types.computeSizeBoolean(self.pre_vote);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: ReplicaEpoch
        if (version >= 0 and version <= 32767) {
            self.replica_epoch = try types.decodeInt32(reader);
        }
        ...
        // Field: LastOffsetEpoch
        if (version >= 0 and version <= 32767) {
            self.last_offset_epoch = try types.decodeInt32(reader);
        }
        ...
        // Field: PreVote
        if (version >= 2 and version <= 32767) {
            self.pre_vote = try types.decodeBoolean(reader);
        }
...
pub const VoteRequest = struct {
    ...
    /// Create a default instance of VoteRequest
    pub fn default() Self {
        return .{
            .cluster_id = null,
            .voter_id = -1,
    ...
    /// Compute the size of VoteRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
