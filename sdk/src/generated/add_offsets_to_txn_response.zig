...
pub const AddOffsetsToTxnResponse = struct {
    const Self = @This();
    ...
    /// Create a default instance of AddOffsetsToTxnResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Encode AddOffsetsToTxnResponse
    ...
    /// Compute the size of AddOffsetsToTxnResponse for the given version
    ...
    /// Decode AddOffsetsToTxnResponse
