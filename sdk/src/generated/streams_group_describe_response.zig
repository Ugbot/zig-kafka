...
pub const TopicInfo = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: Partitions
        if (version >= 0 and version <= 32767) {
            try types.encodeInt32(writer, self.partitions);
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull(KeyValue, writer, self.topic_configs, KeyValue.encode);
            } else {
                try types.encodeArrayNonNull(KeyValue, writer, self.topic_configs, KeyValue.encode);
            }
        }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: Partitions
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt32(self.partitions);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: Partitions
        if (version >= 0 and version <= 32767) {
            self.partitions = try types.decodeInt32(reader);
        }
        ...
        // Field: TopicConfigs
        if (version >= 0 and version <= 32767) {
            self.topic_configs = if (is_flexible)
...
/// Nested struct: TaskIds
pub const TaskIds = struct {
    const Self = @This();
...
pub const Assignment = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull(TaskIds, writer, self.active_tasks, TaskIds.encode);
            } else {
                try types.encodeArrayNonNull(TaskIds, writer, self.active_tasks, TaskIds.encode);
            }
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull(TaskIds, writer, self.standby_tasks, TaskIds.encode);
            } else {
                try types.encodeArrayNonNull(TaskIds, writer, self.standby_tasks, TaskIds.encode);
            }
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayNonNull(TaskIds, writer, self.warmup_tasks, TaskIds.encode);
            } else {
                try types.encodeArrayNonNull(TaskIds, writer, self.warmup_tasks, TaskIds.encode);
            }
        }
