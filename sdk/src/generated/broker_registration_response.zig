...
pub const BrokerRegistrationResponse = struct {
    ...
    /// Create a default instance of BrokerRegistrationResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Encode BrokerRegistrationResponse
    ...
    /// Compute the size of BrokerRegistrationResponse for the given version
    ...
    /// Decode BrokerRegistrationResponse
