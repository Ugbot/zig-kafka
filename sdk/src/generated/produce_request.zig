...
pub const TopicProduceData = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLenNonNull(writer, self.partition_data);
                ...
                try types.encodeArrayLenNonNull(writer, self.partition_data);
                if (self.partition_data) |arr| {
                    for (arr) |*item| {
                        try PartitionProduceData.encode(item, writer, version);
                    }
...
pub const ProduceRequest = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLenNonNull(writer, self.topic_data);
                ...
                try types.encodeArrayLenNonNull(writer, self.topic_data);
                if (self.topic_data) |arr| {
                    for (arr) |*item| {
                        try TopicProduceData.encode(item, writer, version);
                    }
