...
pub const ReadStateResult = struct {
    ...
    /// Versions: 0+
    partitions: ?[]PartitionResult = null,
...
pub const PartitionResult = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: StateEpoch
        if (version >= 0 and version <= 32767) {
            try types.encodeInt32(writer, self.state_epoch);
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLenNonNull(writer, self.state_batches);
                if (self.state_batches) |arr| {
                    for (arr) |*item| {
                        try StateBatch.encode(item, writer, version);
                    }
                }
            } else {
                try types.encodeArrayLenNonNull(writer, self.state_batches);
                if (self.state_batches) |arr| {
                    for (arr) |*item| {
                        try StateBatch.encode(item, writer, version);
                    }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: StateEpoch
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt32(self.state_epoch);
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.state_batches) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try StateBatch.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: StateEpoch
        if (version >= 0 and version <= 32767) {
            self.state_epoch = try types.decodeInt32(reader);
        }
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(StateBatch, array_len);
            for (array) |*item| {
                item.* = try StateBatch.decode(reader, version, allocator);
            }
            self.state_batches = array;
        }
...
pub const StateBatch = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: DeliveryState
        if (version >= 0 and version <= 32767) {
            try types.encodeInt8(writer, self.delivery_state);
        }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: DeliveryState
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt8(self.delivery_state);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: DeliveryState
        if (version >= 0 and version <= 32767) {
            self.delivery_state = try types.decodeInt8(reader);
        }
...
pub const ReadShareGroupStateResponse = struct {
    ...
    /// Create a default instance of ReadShareGroupStateResponse
    pub fn default() Self {
        return .{
            .results = null,
            ._tagged_fields = null,
    ...
    /// The read results.
    pub fn withResults(self: Self, value: ?[]ReadStateResult) Self {
        var result = self;
        result.results = value;
        return result;
    }

    /// Encode ReadShareGroupStateResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.results) |arr| {
                    for (arr) |*item| {
                        try ReadStateResult.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of ReadShareGroupStateResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.results) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try ReadStateResult.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    /// Decode ReadShareGroupStateResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(ReadStateResult, array_len);
            for (array) |*item| {
                item.* = try ReadStateResult.decode(reader, version, allocator);
            }
            self.results = array;
        }
