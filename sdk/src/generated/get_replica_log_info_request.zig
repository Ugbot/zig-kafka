...
//! Message: GetReplicaLogInfoRequest
//! API Key: 93
//! Type: request
//! Valid Versions: 0
//! Flexible Versions: 0+
...
pub const GetReplicaLogInfoRequest = struct {
    const Self = @This();
    ...
    /// Create a default instance of GetReplicaLogInfoRequest
    pub fn default() Self {
        return .{
    ...
    /// Encode GetReplicaLogInfoRequest
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
    ...
    /// Compute the size of GetReplicaLogInfoRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
    ...
    /// Decode GetReplicaLogInfoRequest
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
