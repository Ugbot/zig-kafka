...
pub const TopicProduceResponse = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLenNonNull(writer, self.partition_responses);
                ...
                try types.encodeArrayLenNonNull(writer, self.partition_responses);
                if (self.partition_responses) |arr| {
                    for (arr) |*item| {
                        try PartitionProduceResponse.encode(item, writer, version);
                    }
...
pub const PartitionProduceResponse = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 8 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLenNonNull(writer, self.record_errors);
                ...
                try types.encodeArrayLenNonNull(writer, self.record_errors);
                if (self.record_errors) |arr| {
                    for (arr) |*item| {
                        try BatchIndexAndErrorMessage.encode(item, writer, version);
                    }
