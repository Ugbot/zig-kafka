...
pub const MetadataResponsePartition = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArray(i32, writer, self.replica_nodes, types.encodeInt32);
            } else {
                try types.encodeArray(i32, writer, self.replica_nodes, types.encodeInt32);
            }
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArray(i32, writer, self.isr_nodes, types.encodeInt32);
            } else {
                try types.encodeArray(i32, writer, self.isr_nodes, types.encodeInt32);
            }
        }
        ...
        if (version >= 5 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArray(i32, writer, self.offline_replicas, types.encodeInt32);
            } else {
                try types.encodeArray(i32, writer, self.offline_replicas, types.encodeInt32);
            }
        }
...
pub const MetadataResponse = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                try types.encodeCompactArrayLen(writer, self.brokers);
                if (self.brokers) |arr| {
                    for (arr) |*item| {
                ...
                try types.encodeArrayLen(writer, self.brokers);
                if (self.brokers) |arr| {
                    for (arr) |*item| {
                        try MetadataResponseBroker.encode(item, writer, version);
                    }
