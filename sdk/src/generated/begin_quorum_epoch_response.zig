...
//! Message: BeginQuorumEpochResponse
//! API Key: 53
//! Type: response
//! Valid Versions: 0-1
//! Flexible Versions: 1+
...
pub const BeginQuorumEpochResponse = struct {
    const Self = @This();
    ...
    /// Create a default instance of BeginQuorumEpochResponse
    pub fn default() Self {
        return .{
            .error_code = 0,
            .topics = null,
    ...
    /// Encode BeginQuorumEpochResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
    ...
    /// Compute the size of BeginQuorumEpochResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
    ...
    /// Decode BeginQuorumEpochResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
