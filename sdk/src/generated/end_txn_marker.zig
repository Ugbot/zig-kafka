...
pub const EndTxnMarker = struct {
    ...
    /// Create a default instance of EndTxnMarker
    pub fn default() Self {
        return .{
            .coordinator_epoch = 0,
            ._tagged_fields = null,
    ...
    /// The coordinator epoch when appending the record
    pub fn withCoordinatorEpoch(self: Self, value: i32) Self {
        var result = self;
        result.coordinator_epoch = value;
        return result;
    }
    ...
    /// Compute the size of EndTxnMarker for the given version
