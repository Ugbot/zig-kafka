...
/// Nested struct: DescribeShareGroupOffsetsResponseGroup
pub const DescribeShareGroupOffsetsResponseGroup = struct {
    const Self = @This();
    ...
    /// Versions: 0+
    topics: ?[]DescribeShareGroupOffsetsResponseTopic = null,
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.topics) |arr| {
                    for (arr) |*item| {
                        try DescribeShareGroupOffsetsResponseTopic.encode(item, writer, version);
                    }
                }
            } else {
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        if (version >= 0 and version <= 32767) {
            if (self.topics) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try DescribeShareGroupOffsetsResponseTopic.computeSize(item, version);
                }
            } else {
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(DescribeShareGroupOffsetsResponseTopic, array_len);
            for (array) |*item| {
                item.* = try DescribeShareGroupOffsetsResponseTopic.decode(reader, version, allocator);
            }
            self.topics = array;
        }
...
/// Nested struct: DescribeShareGroupOffsetsResponseTopic
pub const DescribeShareGroupOffsetsResponseTopic = struct {
    const Self = @This();
    ...
    /// Versions: 0+
    partitions: ?[]DescribeShareGroupOffsetsResponsePartition = null,
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.partitions) |arr| {
                    for (arr) |*item| {
                        try DescribeShareGroupOffsetsResponsePartition.encode(item, writer, version);
                    }
                }
            } else {
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        if (version >= 0 and version <= 32767) {
            if (self.partitions) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try DescribeShareGroupOffsetsResponsePartition.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(DescribeShareGroupOffsetsResponsePartition, array_len);
            for (array) |*item| {
                item.* = try DescribeShareGroupOffsetsResponsePartition.decode(reader, version, allocator);
            }
...
/// Nested struct: DescribeShareGroupOffsetsResponsePartition
pub const DescribeShareGroupOffsetsResponsePartition = struct {
    const Self = @This();
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: StartOffset
        if (version >= 0 and version <= 32767) {
            try types.encodeInt64(writer, self.start_offset);
        }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: StartOffset
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt64(self.start_offset);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: StartOffset
        if (version >= 0 and version <= 32767) {
            self.start_offset = try types.decodeInt64(reader);
        }
...
pub const DescribeShareGroupOffsetsResponse = struct {
    const Self = @This();

    /// The duration in milliseconds for which the request was throttled due to a quota violation, or zero if the request did not violate any quota.
    throttle_time_ms: i32 = 0,
    /// The results for each group.
    groups: ?[]DescribeShareGroupOffsetsResponseGroup = null,
    ...
    /// Create a default instance of DescribeShareGroupOffsetsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .groups = null,
    ...
    /// The results for each group.
    pub fn withGroups(self: Self, value: ?[]DescribeShareGroupOffsetsResponseGroup) Self {
        var result = self;
        result.groups = value;
        return result;
    }

    /// Encode DescribeShareGroupOffsetsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.groups) |arr| {
                    for (arr) |*item| {
                        try DescribeShareGroupOffsetsResponseGroup.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of DescribeShareGroupOffsetsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.groups) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try DescribeShareGroupOffsetsResponseGroup.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    /// Decode DescribeShareGroupOffsetsResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(DescribeShareGroupOffsetsResponseGroup, array_len);
            for (array) |*item| {
                item.* = try DescribeShareGroupOffsetsResponseGroup.decode(reader, version, allocator);
            }
            self.groups = array;
        }
