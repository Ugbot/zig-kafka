...
/// Nested struct: DeleteRecordsTopicResult
pub const DeleteRecordsTopicResult = struct {
    ...
    /// Versions: 0+
    partitions: ?[]DeleteRecordsPartitionResult = null,
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.partitions) |arr| {
                    for (arr) |*item| {
                        try DeleteRecordsPartitionResult.encode(item, writer, version);
                    }
                }
            } else {
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        if (version >= 0 and version <= 32767) {
            if (self.partitions) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try DeleteRecordsPartitionResult.computeSize(item, version);
                }
            } else {
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(DeleteRecordsPartitionResult, array_len);
            for (array) |*item| {
                item.* = try DeleteRecordsPartitionResult.decode(reader, version, allocator);
            }
...
/// Nested struct: DeleteRecordsPartitionResult
pub const DeleteRecordsPartitionResult = struct {
    ...
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        // Field: LowWatermark
        if (version >= 0 and version <= 32767) {
            try types.encodeInt64(writer, self.low_watermark);
        }
    ...
    pub fn computeSize(self: *const Self, version: i16) !usize {
        ...
        // Field: LowWatermark
        if (version >= 0 and version <= 32767) {
            total_size += types.computeSizeInt64(self.low_watermark);
        }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        // Field: LowWatermark
        if (version >= 0 and version <= 32767) {
            self.low_watermark = try types.decodeInt64(reader);
        }
...
pub const DeleteRecordsResponse = struct {
    ...
    topics: ?[]DeleteRecordsTopicResult = null,
    ...
    /// Create a default instance of DeleteRecordsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .topics = null,
    ...
    /// Each topic that we wanted to delete records from.
    pub fn withTopics(self: Self, value: ?[]DeleteRecordsTopicResult) Self {
        var result = self;
        result.topics = value;
        return result;
    }

    /// Encode DeleteRecordsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.topics) |arr| {
                    for (arr) |*item| {
                        try DeleteRecordsTopicResult.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of DeleteRecordsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.topics) |arr| {
                ...
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(len) else 4;
                for (arr) |*item| {
                    total_size += try DeleteRecordsTopicResult.computeSize(item, version);
                }
            } else {
                total_size += if (is_flexible) types.computeSizeUnsignedVarInt(1) else 4;
            }
    ...
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        ...
        if (version >= 0 and version <= 32767) {
            const array_len = if (is_flexible) try types.decodeCompactArrayLen(reader) else try types.decodeArrayLen(reader);
            const array = try allocator.alloc(DeleteRecordsTopicResult, array_len);
            for (array) |*item| {
                item.* = try DeleteRecordsTopicResult.decode(reader, version, allocator);
            }
            self.topics = array;
        }
