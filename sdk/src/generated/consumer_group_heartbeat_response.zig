...
pub const ConsumerGroupHeartbeatResponse = struct {
    ...
    /// Create a default instance of ConsumerGroupHeartbeatResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .error_code = 0,
    ...
    /// Encode ConsumerGroupHeartbeatResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
    ...
    /// Compute the size of ConsumerGroupHeartbeatResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
    ...
    /// Decode ConsumerGroupHeartbeatResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
