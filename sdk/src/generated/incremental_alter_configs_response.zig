...
pub const IncrementalAlterConfigsResponse = struct {
    ...
    /// Create a default instance of IncrementalAlterConfigsResponse
    pub fn default() Self {
        return .{
            .throttle_time_ms = 0,
            .responses = null,
    ...
    /// Encode IncrementalAlterConfigsResponse
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
    ...
    /// Compute the size of IncrementalAlterConfigsResponse for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
    ...
    /// Decode IncrementalAlterConfigsResponse
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
