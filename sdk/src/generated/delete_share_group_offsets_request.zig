...
/// Nested struct: DeleteShareGroupOffsetsRequestTopic
pub const DeleteShareGroupOffsetsRequestTopic = struct {
    const Self = @This();
...
pub const DeleteShareGroupOffsetsRequest = struct {
    const Self = @This();

    /// The group identifier.
    group_id: []const u8 = "",
    /// The topics to delete offsets for.
    topics: ?[]DeleteShareGroupOffsetsRequestTopic = null,
    ...
    /// Create a default instance of DeleteShareGroupOffsetsRequest
    pub fn default() Self {
        return .{
            .group_id = "",
            .topics = null,
    ...
    /// The topics to delete offsets for.
    pub fn withTopics(self: Self, value: ?[]DeleteShareGroupOffsetsRequestTopic) Self {
        var result = self;
        result.topics = value;
        return result;
    }

    /// Encode DeleteShareGroupOffsetsRequest
    pub fn encode(self: *const Self, writer: anytype, version: i16) !void {
        ...
        if (version >= 0 and version <= 32767) {
            if (is_flexible) {
                ...
                if (self.topics) |arr| {
                    for (arr) |*item| {
                        try DeleteShareGroupOffsetsRequestTopic.encode(item, writer, version);
                    }
                }
            } else {
    ...
    /// Compute the size of DeleteShareGroupOffsetsRequest for the given version
    pub fn computeSize(self: *const Self, version: i16) !usize {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            if (self.topics) |arr| {
                ...
                for (arr) |*item| {
                    total_size += try DeleteShareGroupOffsetsRequestTopic.computeSize(item, version);
                }
            } else {
    ...
    /// Decode DeleteShareGroupOffsetsRequest
    pub fn decode(reader: anytype, version: i16, allocator: std.mem.Allocator) !Self {
        if (!isValidVersion(version)) {
            return types.Error.UnsupportedVersion;
        }
        ...
        if (version >= 0 and version <= 32767) {
            ...
            const array = try allocator.alloc(DeleteShareGroupOffsetsRequestTopic, array_len);
            for (array) |*item| {
                item.* = try DeleteShareGroupOffsetsRequestTopic.decode(reader, version, allocator);
            }
            self.topics = array;
        }
