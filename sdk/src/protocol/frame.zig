...
pub const Body = union(enum) {
    ...
    metadata_request: kafka_gen.metadata_request.MetadataRequest,
    api_versions_request: kafka_gen.api_versions_request.ApiVersionsRequest,

    fetch_response: kafka_gen.fetch_response.FetchResponse,
    produce_response: kafka_gen.produce_response.ProduceResponse,
    metadata_response: kafka_gen.metadata_response.MetadataResponse,
    api_versions_response: kafka_gen.api_versions_response.ApiVersionsResponse,
    ...
    pub fn decodeRequest(reader: anytype, api_key: i16, api_version: i16, allocator: std.mem.Allocator) !Body {
        return switch (api_key) {
            ...
            3 => .{ .metadata_request = try kafka_gen.metadata_request.MetadataRequest.decode(reader, api_version, allocator) },
            18 => .{ .api_versions_request = try kafka_gen.api_versions_request.ApiVersionsRequest.decode(reader, api_version, allocator) },
